                        ...
                        <div class="card-box p-5">
                            ...
                            <div class="account-content text-center">
                                ...
                                <p class="text-muted font-14 mt-2"> A email has been send to <b>{{Auth::user()->email}}</b>.
                                    Please check for an email from company and click on the included link to confirm your account </p>

                                <a href="{{route('person.dashboard')}}" class="btn btn-md btn-block btn-custom waves-effect waves-light mt-3">Back to Home</a>
                            </div>
